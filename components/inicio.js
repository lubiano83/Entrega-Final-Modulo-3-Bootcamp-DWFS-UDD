export default function inicio() {
    return (
        `
            <section class="flex flex-col justify-center items-center gap-4 max-w-5xl w-3/4 min-w-72 min-h-screen scroll-mt-4 xl:scroll-mt-2 xl:pl-64" id="inicio">
                <strong class="text-2xl text-orange-500 xl:text-blue-500">¡Bienvenidos a Enjoy The App!</strong>
