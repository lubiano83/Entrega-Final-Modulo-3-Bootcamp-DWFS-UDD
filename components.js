...
content.productos = `<section class="w-screen flex flex-col justify-center items-center gap-6 min-h-screen scroll-mt-28" id="productos">
                ...
                <div class="w-full flex justify-center items-start gap-6 flex-wrap">
                    ...
                    <article class="group relative flex flex-col p-2 gap-4 w-72 hover:shadow-md hover:shadow-gray-700 aspect-[1/1.8] overflow-hidden">
                        ...
                        <h3 class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-blue-300 text-white flex items-center justify-center p-2 text-left">Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi excepturi aliquid temporibus voluptas possimus, accusantium cupiditate aspernatur et! Modi rerum illo error hic. Porro distinctio voluptatem sed, ut ratione hic!</h3>
                    </article>
                    <article class="group relative flex flex-col p-2 gap-4 w-72 hover:shadow-md hover:shadow-gray-700 aspect-[1/1.8] overflow-hidden">
